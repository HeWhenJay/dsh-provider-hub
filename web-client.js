window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const {
      ...
      IconCheckOutline16, IconLoadingOutline16, IconSettingsOutline16
    ...
    function ServiceCard({ hub }) {
      ...
      return React.createElement('div', { className: 'ph-hero' },
        ...
        React.createElement('div', { className: 'ph-actions' },
          ...
          React.createElement(Button, { variant: 'ghost', size: 'sm', icon: React.createElement(IconSettingsOutline16, { size: 16 }), onClick: () => setEditing(true) }, '服务设置'),
    ...
    function AccountService({ hub }) {
      ...
      return React.createElement(React.Fragment, null,
        React.createElement('div', { className: 'ph-sectionTitle' }, React.createElement('div', null, React.createElement('h3', null, '内置官方账号服务'), React.createElement('div', { className: 'ph-help' }, 'Provider Hub 自行下载并校验固定版本的账户服务；无需安装其他桌面程序。')), React.createElement('div', { className: 'ph-actions' },
          ...
          React.createElement(Button, { variant: 'ghost', size: 'sm', icon: React.createElement(IconSettingsOutline16, { size: 16 }), onClick: () => setEditing(true) }, '设置'),
    ...
    module.exports.apply = (ctx) => {
      ...
      ctx.slots.inject('settings.section', () => ctx.slots.register({ name: 'settings.section', id: 'provider-hub', order: 40, label: () => t('nav'), locale: NS }, SettingsPage));
    };
